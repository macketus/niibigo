...
func doMake(arg2, arg3 string) error {
	...
	case "migration":
		...
		upFile := nii.RootPath + "/migrations/" + fileName + "." + dbType + ".up.sql"
		downFile := nii.RootPath + "/migrations/" + fileName + "." + dbType + ".down.sql"
	...
	case "handler":
		...
		fileName := nii.RootPath + "/handlers/" + strings.ToLower(arg3) + ".go"
	...
	case "model":
		...
		fileName := nii.RootPath + "/data/" + strings.ToLower(modelName) + ".go"
		if fileExists(fileName) {
			exitGracefully(errors.New(fileName + "already exists"))
		}
	...
	case "mail":
		...
		htmlMail := nii.RootPath + "/mail/" + strings.ToLower(arg3) + ".html.tmpl" 
		plainMail := nii.RootPath + "/mail/" + strings.ToLower(arg3) + ".plain.tmpl"   
